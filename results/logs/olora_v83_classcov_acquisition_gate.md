...
- Decision: `reject`
- Heldout EM: `43.4`
- Negative/positive counts: `81` / `52`
- Negative/positive accuracy: `32.0755` / `26.2626`
- Reject reasons: `heldout EM 43.4 does not exceed baseline 53.4`

## v83_r2

- Decision: `reject`
- Heldout EM: `53.0`
- Negative/positive counts: `24` / `5`
- Negative/positive accuracy: `16.0377` / `3.0303`
- Reject reasons: `heldout EM 53.0 does not exceed baseline 53.4 | negative prediction count 24 < baseline 40 | positive prediction count 5 < baseline 13 | negative per-label accuracy 16.0377 < 20.0 | positive per-label accuracy 3.0303 < 5.0`
