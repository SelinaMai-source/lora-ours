...
print("Let's check if the model produces valid logits for a prompt from the dataset, step 2.")
...
decoder_input_ids = torch.tensor([[model.config.decoder_start_token_id, 3]])
...
print("Wait, what is token 632?")
print("Token 632 is", tokenizer.decode([632]))
print("Is it in the top 50?")
top_50 = torch.topk(logits[0, 1, :], 50).indices.tolist()
if 632 in top_50:
    print("Yes, at rank", top_50.index(632))
else:
    print("No")
