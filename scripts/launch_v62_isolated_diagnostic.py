...
RUN_NAME = "standard_peft_cl_o_lora_standard_order1_seed1_ours_strict_v62_isolated_eval_exit_diagnostic"
CONFIG = "configs/ccfa_three_suite/standard_peft_cl_o_lora_standard_order1_seed1_ours_strict_v62_isolated_eval_exit_diagnostic.yaml"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Launch the v62 diagnostic without inheriting parent-shell SIGHUP.")
