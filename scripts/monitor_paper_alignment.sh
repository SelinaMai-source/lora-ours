...
while true; do
  ...
  [[ "$arper_b" == "nan" ]] && arper_b="$(get_arper_bleu arper_woz3_paper_aligned_exemplar500_batch128_formal_v89)"
  [[ "$arper_b" == "nan" ]] && arper_b="$(get_arper_bleu arper_woz3_paper_aligned_exemplar500_formal_v87)"
  arper_s="$(get_arper_ser arper_woz3_paper_aligned_exemplar250_formal_v88)"
  [[ "$arper_s" == "nan" ]] && arper_s="$(get_arper_ser arper_woz3_paper_aligned_exemplar500_batch128_formal_v89)"
  [[ "$arper_s" == "nan" ]] && arper_s="$(get_arper_ser arper_woz3_paper_aligned_exemplar500_formal_v87)"
  todcl_b="nan"
  todcl_e="nan"
