...
MANIFEST="${MANIFEST:-results/tables/phase2_full_benchmark_manifest.csv}"
STATUS_CSV="${STATUS_CSV:-results/tables/phase2_full_benchmark_status.csv}"
LOG_DIR="${LOG_DIR:-results/logs/phase2_full_benchmark}"
