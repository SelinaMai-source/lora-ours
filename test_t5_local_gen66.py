...
print("Let's check the generation of the base model on a different task type, with max_new_tokens=64 and without any other kwargs, but skip_special_tokens=True, and with a different prompt format.")
