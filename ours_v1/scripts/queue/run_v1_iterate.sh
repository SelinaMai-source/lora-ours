#!/usr/bin/env bash
# Serial GPU queue for ours-v1 overlay iteration.
set -euo pipefail
...
JOBS=(
  ...
  "standard-v1-smoke|lora-ours-standard-v1-smoke|cd ${REPO_ROOT} && bash ours_v1/scripts/launchers/run_standard_v1.sh"
  "citb-v1-smoke|lora-ours-citb-ours-v1-smoke|cd ${REPO_ROOT} && bash ours_v1/scripts/launchers/run_citb_v1.sh"
  "arper-v1-ssrg-smoke|lora-ours-arper-v1-ssrg-smoke|cd ${REPO_ROOT} && BOUNDED_SMOKE=1 bash ours_v1/scripts/launchers/run_arper_v1.sh"
  "todcl-v1-assess-smoke|lora-ours-todcl-v1-assess-overlay|cd ${REPO_ROOT} && BOUNDED_SMOKE=1 bash ours_v1/scripts/launchers/run_todcl_v1.sh"
)
